    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="回访内容" prop="huifangneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="回访内容"
                  v-model="ruleForm.huifangneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.huifangneirong" label="回访内容" prop="huifangneirong">
                    <span>{{ruleForm.huifangneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kehumingcheng = true;
          ...
          if(o=='huifangneirong'){
            this.ruleForm.huifangneirong = obj[o];
	    this.ro.huifangneirong = true;
            continue;
          }
          if(o=='dengjishijian'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shouhouhuifang/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shouhouhuifangCrossAddOrUpdateFlag = false;
						 this.parent.search();
