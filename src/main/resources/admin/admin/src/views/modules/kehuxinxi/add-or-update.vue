<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="客户来源" prop="kehulaiyuan">
          <el-select :disabled="ro.kehulaiyuan" v-model="ruleForm.kehulaiyuan" placeholder="请选择客户来源">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="客户来源" prop="kehulaiyuan">
	      <el-input v-model="ruleForm.kehulaiyuan"
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="国家地区" prop="guojiadiqu">
          <el-input v-model="ruleForm.guojiadiqu" 
              placeholder="国家地区" clearable  :readonly="ro.guojiadiqu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="国家地区" prop="guojiadiqu">
              <el-input v-model="ruleForm.guojiadiqu" 
                placeholder="国家地区" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="邮件" prop="youjian">
          <el-input v-model="ruleForm.youjian" 
              placeholder="邮件" clearable  :readonly="ro.youjian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="邮件" prop="youjian">
              <el-input v-model="ruleForm.youjian" 
                placeholder="邮件" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fuzeren = true;
          ...
          if(o=='kehulaiyuan'){
            this.ruleForm.kehulaiyuan = obj[o];
	    this.ro.kehulaiyuan = true;
            continue;
          }
          if(o=='xingye'){
	    ...
	    this.ro.xingye = true;
          ...
          if(o=='guojiadiqu'){
            this.ruleForm.guojiadiqu = obj[o];
	    this.ro.guojiadiqu = true;
            continue;
          }
          if(o=='dianhua'){
	    ...
	    this.ro.dianhua = true;
          ...
          if(o=='youjian'){
            this.ruleForm.youjian = obj[o];
	    this.ro.youjian = true;
            continue;
          }
        }
      }
