<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.chanpinfengmian" label="产品封面" prop="chanpinfengmian">
          <file-upload
          tip="点击上传产品封面"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.chanpinfengmian?ruleForm.chanpinfengmian:''"
          @change="chanpinfengmianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.chanpinfengmian" label="产品封面" prop="chanpinfengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.chanpinfengmian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chanpinfenlei = true;
          ...
          if(o=='chanpinfengmian'){
            this.ruleForm.chanpinfengmian = obj[o];
	    this.ro.chanpinfengmian = true;
            continue;
          }
          if(o=='shuliang'){
	...
	this.ruleForm.chanpinxiangqing = this.ruleForm.chanpinxiangqing.replace(reg,'../../../springbootl8m1o/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.chanpinfengmian!=null) {
		this.ruleForm.chanpinfengmian = this.ruleForm.chanpinfengmian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    chanpinfengmianUploadChange(fileUrls) {
	this.ruleForm.chanpinfengmian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
